...
async def auto_refresh_account(player_pid: str = f"{default_account}"):
    ...
    with open(fr"app\data\battlefield\managerAccount\{player_pid}\account.json", 'r', encoding='utf-8') as file_temp1:
    ...
    with open(fr"app\data\battlefield\managerAccount\{player_pid}\session.json", 'w', encoding="utf-8") as file_temp2:
